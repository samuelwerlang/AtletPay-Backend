/*
  ...
  - The values [OVERDUE] on the enum `ChargeStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ChargeStatus_new" AS ENUM ('PENDING', 'PAID', 'FAILED', 'CANCELED');
